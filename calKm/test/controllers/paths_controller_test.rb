...
class PathsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post paths_url, params: { path: { date: @path.date, distance: @path.distance, horsepower: @path.horsepower, name: @path.name, total: @path.total } }
    end
  ...
  test "should update path" do
    patch path_url(@path), params: { path: { date: @path.date, distance: @path.distance, horsepower: @path.horsepower, name: @path.name, total: @path.total } }
